...
| [**基于动作和玩家输入组件**](playerInput.zh.md)<br><br>此工作流提供了额外的功能，你可以直接将动作的**回调**连接到你自己的回调处理方法，从而无需在代码中处理动作引用。它还提供了一些对**本地多人游戏**场景（如设备分配和分屏功能）非常有用的特性。 | ![Workflow-PlayerInput.png](/assets/images/translation/unity-input-system-1.19.0-docs/introduction/workflows/Workflow-PlayerInput.png) |
